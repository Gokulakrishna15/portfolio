 ...
 * FIX: Removed "fixed" from className — was overlaying the entire page viewport.
 * Now uses "absolute" so it stays contained within the AI section only.
 */
const InteractiveNeuralNetwork = () => {
  ...
  // ✅ FIX: "fixed" removed — now "absolute" so it stays inside the section
  return <canvas ref={canvasRef} className="absolute inset-0 z-0 pointer-events-none opacity-40 mix-blend-screen w-full h-full" />;
};
...
const QuantumCore = () => {
  return (
    <div className="relative w-80 h-80 flex items-center justify-center mb-16 animate-float z-20">
      ...
      <div className="relative w-44 h-44 rounded-full bg-gradient-to-br from-cyan-900 to-[#030014] shadow-[0_0_100px_rgba(6,182,212,0.3)] flex items-center justify-center overflow-hidden border border-cyan-500/50 z-10 group">
...
const AIChatSimulator = () => {
  ...
  return (
    <div className="w-full max-w-lg bg-[#05050a]/90 backdrop-blur-2xl border border-white/10 rounded-2xl p-0 font-mono text-sm shadow-[0_20px_50px_rgba(0,0,0,0.8)] relative overflow-hidden flex flex-col h-80 z-20 hover:border-cyan-500/30 transition-colors duration-500">
      ...
      <div className="absolute inset-x-0 bottom-0 h-[1px] bg-gradient-to-r from-transparent via-cyan-500 to-transparent opacity-70 shadow-[0_0_15px_#22d3ee]" />
    </div>
  );
};
        ...
        {tool.metrics.map((metric, i) => (
          <div key={i} className="group/metric">
            ...
            <div className="h-1.5 w-full bg-black/80 rounded-full overflow-hidden border border-white/5">
              <div 
                className="h-full rounded-full transition-all duration-[2000ms] relative overflow-hidden"
                style={{ 
    ...
    <div ref={ref} className="w-full max-w-7xl mx-auto mt-40 relative z-20">
      <div className={`text-center mb-16 transition-all duration-1000 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <h3 className="text-4xl md:text-6xl font-black text-white mb-6 tracking-tighter">
          AI IN THE <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-cyan-400">MODERN WORLD</span>
        </h3>
...
export default function NeuralNexusOS() {
  return (
    <section id="ai-os" className="relative min-h-screen py-24 px-4 sm:px-6 lg:px-8 bg-[#030014] overflow-hidden text-slate-100 flex flex-col items-center selection:bg-cyan-500/30 selection:text-cyan-100 font-sans">
      ...
      {/* --- BACKGROUND — absolute, NOT fixed, stays inside this section --- */}
      <InteractiveNeuralNetwork />

      {/*
        ✅ FIX: Removed "fixed" from this gradient overlay.
        Was: className="... fixed"
        Now: className="... absolute"
        "fixed" was pinning this dark vignette over the entire page viewport,
        making every other section (Projects, Skills, etc.) look washed out.
      */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(17,24,39,0)_0%,rgba(3,0,20,1)_70%)] pointer-events-none z-10" />
      ...
      <div className="relative z-20 max-w-7xl w-full flex flex-col items-center">
        ...
        <div className="text-center mb-16 pt-10 animate-slide-up">
          ...
          <h2 className="text-6xl md:text-[5.5rem] font-black text-transparent bg-clip-text bg-gradient-to-b from-white via-slate-200 to-slate-600 tracking-tighter mb-8 drop-shadow-2xl leading-none">
            HUMAN <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-500">+</span> AI SYNERGY
          </h2>
        ...
        <div className="mt-48 mb-24 w-full relative group">
          <div className="absolute -inset-1 bg-gradient-to-r from-cyan-600 via-purple-600 to-cyan-600 rounded-[3rem] blur-xl opacity-20 group-hover:opacity-50 transition duration-1000 animate-shimmer bg-[length:200%_auto]" />
          ...
          <div className="relative bg-[#05050a]/90 backdrop-blur-2xl border border-white/10 rounded-[2.5rem] p-12 md:p-20 flex flex-col md:flex-row items-center justify-between gap-12 overflow-hidden shadow-2xl">
            ...
            <div className="z-10 max-w-3xl">
              <h3 className="text-4xl md:text-6xl font-black text-white mb-6 leading-tight tracking-tighter">
                Ready to architect the <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400">future?</span>
              </h3>
